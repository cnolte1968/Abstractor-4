# RELEVANTOR FUNCTION EXECUTION MODEL (FUNCTION COGNITIVE ARCHITECTURE)

## 1. ZWECK DIESES DOKUMENTS
Dieses Dokument definiert das herrschende und verbindliche **Function Execution Model** für alle 10 Analysefunktionen des Relevantors. Es ergänzt die globale Prompt-Basis (`_global_quality_rules.md`) und das Funktionsprompt-Template (`_function_prompt_template.md`).
