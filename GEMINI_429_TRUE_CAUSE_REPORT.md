...
| :--- | :--- | :--- |
| System.getenv | `GEMINI_API_KEY` | null/empty |
| System.getenv | `Gemini_Relevantor` | Length: 53, Pref: AQ.Ab8..., Suff: ...6gzw, hash8: 9f42edf4 |
| BuildConfig | `GEMINI_API_KEY` | Length: 17, Pref: MY_GEM..., Suff: ..._KEY, hash8: be5a4fa0 |
| BuildConfig | `Gemini_Relevantor` | Length: 13, Pref: MY_GEM..., Suff: ..._KEY, hash8: 73c18aad |

- **Verwendeter Schlüssel zur Laufzeit**: `Length: 53, Pref: AQ.Ab8..., Suff: ...6gzw, hash8: 9f42edf4` (Erkennungsart: Anderer Key)
...
2. **Projekt/API-Key-Zuordnung**:
   ...
   - Wenn der Schlüssel in BuildConfig oder Umgebungsvariablen nicht mit dem zahlungspflichtigen Projekt "Relevantor" übereinstimmt, nutzt die App unbemerkt den Standard-Free-Tier-Schlüssel und fällt unter dessen strenge Limits.
